...
const AGENTS = [
  ...
  },
  {
    ...
    type: 'classify',
    icon: <FaRegSmile size={24} />,
    description: 'Advanced sentiment classification.',
    placeholder: 'Enter text to classify',
  },
]
...
function AgentCard({
  ...
  return (
    <div className='w-80 flex-shrink-0 snap-center rounded-xl bg-white p-5 shadow-sm border border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800 flex flex-col'>
